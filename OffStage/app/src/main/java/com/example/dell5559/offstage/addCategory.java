...
public class addCategory extends AppCompatActivity {
    ...
    public void delete(View v) {
        ...
        if (!todo_MainActivity.cat.get(position).getName().equals("none")) {
            todo_MainActivity.cat.remove(position);
    ...
    public void dialog(View view) {
        ...
        dialog.findViewById(R.id.ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    if (name.equals(todo_MainActivity.getCat().get(i).getName()))
                        ok = false;
                    i++;
                }
                if (ok) {
                    todo_MainActivity.cat.add(new Categorie(name, finalColor));
