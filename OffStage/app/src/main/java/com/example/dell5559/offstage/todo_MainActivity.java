...
public class todo_MainActivity extends AppCompatActivity {
       ...
       getData();
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intentMain = new Intent(todo_MainActivity.this, EditItem.class);
        ...
        ItemAdapter adapter = new ItemAdapter(todo_MainActivity.this, items);
        checkAdapter adapter1 = new checkAdapter(todo_MainActivity.this, cat);
    ...
    public void add(View v) {
        Intent intentMain = new Intent(todo_MainActivity.this, AddItem.class);
        startActivityForResult(intentMain, 1);
    }
    ...
    public void affListCorresponding() {
        ...
        ItemAdapter adapter = new ItemAdapter(todo_MainActivity.this, tmp);
        mListView.setAdapter(adapter);
        if (tmp.size() > 1)
    ...
    public void addCategorie(View v) {
        Intent intentMain = new Intent(todo_MainActivity.this, addCategory.class);
