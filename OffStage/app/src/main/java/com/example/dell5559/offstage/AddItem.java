...
import static com.example.dell5559.offstage.R.id.date;
...
public class AddItem extends AppCompatActivity {
    ...
    public void addItemsOnSpinner2() {
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                findViewById(R.id.textBar).setBackgroundColor(todo_MainActivity.getCat().get(position).getColor());
                findViewById(R.id.title).setBackgroundColor(todo_MainActivity.getCat().get(position).getColor());
            }
    ...
    public void save(View view) throws ParseException {
        ...
        Log.e("current date", String.valueOf(current));
