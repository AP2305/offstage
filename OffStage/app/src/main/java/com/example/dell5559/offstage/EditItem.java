...
public class EditItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int i = 0;
        int selection = 0;
        while (i < todo_MainActivity.getCat().size()) {
            if (categorie.equals(todo_MainActivity.getCat().get(i).getName())) {
                ((RelativeLayout) findViewById(R.id.textBar)).setBackgroundColor(todo_MainActivity.getCat().get(i).getColor());
                ((RelativeLayout) findViewById(R.id.textBar1)).setBackgroundColor(todo_MainActivity.getCat().get(i).getColor());
                ((TextView) findViewById(R.id.title)).setBackgroundColor(todo_MainActivity.getCat().get(i).getColor());
                selection = i;
            }
            i++;
        }
    ...
    public void addItemsOnSpinner2() {
        ...
        int i = 0;
        while (i < todo_MainActivity.getCat().size()) {
            list.add(todo_MainActivity.getCat().get(i).getName());
            i++;
        }
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ((RelativeLayout) findViewById(R.id.textBar)).setBackgroundColor(todo_MainActivity.getCat().get(position).getColor());
                ((RelativeLayout) findViewById(R.id.textBar1)).setBackgroundColor(todo_MainActivity.getCat().get(position).getColor());
                ((TextView) findViewById(R.id.title)).setBackgroundColor(todo_MainActivity.getCat().get(position).getColor());
            }
